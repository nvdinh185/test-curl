...
test-post-file-OK:
- curl -i -X POST -H "Content-Type: multipart/form-data" -F "data=@1.pdf" http://localhost:3000/test/test-post-file
- curl -i -X POST -H "Content-Type: multipart/form-data" -F "data=@1.pdf" -F "id=123" http://localhost:3000/test/test-post-file